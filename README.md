...
This is a website that lists some interesting and/or useful nostr-related tools created by the Coracle organization.

# App List

For those of you who don't care about a fancy website, here is a list of the apps included:

- [Coracle](https://coracle.social/) - Coracle's flagship product, a microblogging client with some experimental design decisions. [source code](https://github.com/coracle-social/coracle)
- [Flotilla](https://flotilla.social/) - A relays-as-groups chat app modeled after Discord. Built with a focus on UX. [source code](https://github.com/coracle-social/flotilla)
...
- [Dufflepud](https://github.com/coracle-social/dufflepud) - A utility server for fetching NIP 05 handles, NIP 11 documents, zapper metadata, link previews, and media alerts. [source code](https://github.com/coracle-social/dufflepud)
